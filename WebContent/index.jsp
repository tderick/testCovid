			...
			<div class="container">
				<div class="row">
					...
					<p class="bold text-left">
						<!-- <a class="btn btn-success" href="param1">Go To param1</a>
						<a class="btn info" href="param1">Go To mes__tests/index.jsp</a> -->
						Monday - Saturday, 8am to 10pm </p>
					</div>
					<div class="col-sm-6 col-md-6">
			  ...
			  <ul class="nav navbar-nav">
				...
				<li class="dropdown">
				  ...
				  <ul class="dropdown-menu">
					<li><a href="index.jsp">Home form</a></li>
					<li><a href="index-video.html">Home video</a></li>
					<li><a href="index-cta.jsp">Home CTA</a></li>
